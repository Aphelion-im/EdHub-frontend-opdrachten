...
const andre = {
  ...
  achternaam: 'de Groot',
  leeftijd: 48,
  geboortedatum: new Date(1974, 6, 28), // Juli is 6. 0 based index voor maanden lijkt het.
};

// ===  Opdracht 2 ===
// Zorg ervoor dat de volgende string in de terminal wordt gelogd:
// "Hoi! Ik ben <voornaam>, ik ben <leeftijd> jaar oud."
console.log(`Hoi! Ik ben ${andre.voornaam}, ik ben ${andre.leeftijd} jaar oud.`);
...
product["color"] = "roze"; // Of: product.color = "roze";
...
const productDescription = product.productName + ", " + product.material[0] + ", " + product.material[1];
