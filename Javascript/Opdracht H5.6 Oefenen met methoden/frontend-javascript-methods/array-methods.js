...
console.log('Verwijderd ingredient: ' + removedItem);
console.log('Nieuwe lijst ingredienten: ' + brownieIngredients);
...
const reversedNames = names.reverse(); // Array.reverse();
...
cities.splice(1, 0, 'Amsterdam'); // Geeft geen nieuwe array, maar overschrijft de originele array.
console.log(cities);
