...
// ==========================================
console.log(
  `${start} My name is ${myName}. The color of my eyes is ${colorEyes}. My age is ${myAge}. I am ${myCurrentJob}. My shoesize: ${shoeSize}. Partner: ${havePartner}. Number of kids ${numberOfKids}.`
);

// Nova's methode
console.log(myName, colorEyes, myAge, myCurrentJob, shoeSize, havePartner, numberOfKids);